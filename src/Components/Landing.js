...
import { faGithub, faLinkedin, faInstagram, faTwitter, faMedium } from "@fortawesome/free-brands-svg-icons";
    ...
    return (
      <section className="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
        <div className="w-100">
          ...
          <div className="subheading mb-5">{this.landingData.location}
          ...
          <div className="social-icons">
            ...
            <a href={this.landingData.medium}>
